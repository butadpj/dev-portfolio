...
experience getting high traffic on their web app, or, if they do, they are left wondering.. 
_"Why the server is crashing?"_, _"Why do requests were timing out?"_. So, it's important you learn how to simulate large traffic locally and identifying where your app slows down (whether it's your server, database, or network)

## [Starting with performance and load testing](#starting-with-performance-and-load-testing)
<InfoCard
  text="
For simplicity, I'll assume you have your backend (API endpoints) separate from your frontend.
"
/>
